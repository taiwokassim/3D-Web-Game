...
export const CharacterController = () => {
    ...
    useFrame(({ camera, mouse }) => {
        if (rb.current && container.current && character.current && cameraPosition.current) {
        ...
        // CAMERA
        if (container.current && cameraPosition.current && cameraTarget.current) {
    ...
    return (
        <RigidBody colliders={false} lockRotations ref={rb} onCollisionEnter={() => setIsGrounded(true)}>
            <group ref={container}>
